"""Integration coverage for crawl subscription behavior.

These tests intentionally exercise real DB-backed subscription behavior instead
of mocking out query paths, so they remain in the integration test suite.
"""
