# This integration test was written before database queries were moved into
# dedicated modules. It remains as an end-to-end subscription behavior test and
# may be split into narrower unit tests in the future.
