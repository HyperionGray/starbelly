...
See docs/implementation/STREAMING_API.md for details on what protobuf changes
are needed.
"""
...
def main():
    ...
    print("See ../docs/implementation/STREAMING_API.md for implementation details.")
    print()
